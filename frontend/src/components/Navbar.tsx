...
export default function Navbar() {
  ...
  // Guard localStorage access during SSR/prerender
  const userEmail =
    typeof window !== "undefined" && window.localStorage
      ? window.localStorage.getItem("userEmail") || user?.email || ""
      : user?.email || "";
    ...
    const fetchUnreadCount = async () => {
      try {
        const response = await fetch(
          `http://localhost:8083/api/notifications/unread-count?userEmail=${encodeURIComponent(
            userEmail
          )}`
        );
        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden md:flex items-center space-x-8">
            ...
            {user?.role?.toUpperCase() === "ADMIN" && (
              <>
                <a
                  ...
                  className={getNavLinkClass("/Dashboard/admin/employees")}
                >
                  Employee Management
                </a>
                <a
                  href="/Dashboard/admin/services"
                  className={getNavLinkClass("/Dashboard/admin/services")}
                >
                  Services
                </a>
                <a
            ...
            {user?.role?.toUpperCase() === "EMPLOYEE" && (
              <>
                <a
                  href="/Dashboard/employee/assignments"
                  className={getNavLinkClass("/Dashboard/employee/assignments")}
                >
                  My Assignments
                </a>
                <a
                  href="/Dashboard/employee/schedule"
                  className={getNavLinkClass("/Dashboard/employee/schedule")}
                >
                  Schedule
                </a>
              </>
            ...
            {user?.role?.toUpperCase() === "CUSTOMER" && (
              <>
                ...
                <a
                  ...
                  className={getNavLinkClass("/Dashboard/book-service")}
                >
                  Book Service
                </a>
                <a
                  href="/Dashboard/vehicles"
                  className={getNavLinkClass("/Dashboard/vehicles")}
                >
                  My Vehicles
                </a>
                <a
                  href="/Dashboard/history"
                  className={getNavLinkClass("/Dashboard/history")}
                >
                  History
                </a>
              </>
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      >
                        <path
                          strokeLinecap="round"
                          strokeLinejoin="round"
                          d="M15 9h3.75M15 12h3.75M15 15h3.75M4.5 19.5h15a2.25 2.25 0 002.25-2.25V6.75A2.25 2.25 0 0019.5 4.5h-15a2.25 2.25 0 00-2.25 2.25v10.5A2.25 2.25 0 004.5 19.5zm6.75-13.5V7.5c0-1.242-.94-2.25-2.1-2.25h-3.3c-1.16 0-2.1.008-2.1 2.25v0c0 1.242.94 2.25 2.1 2.25h3.3c1.16 0 2.1-.008 2.1-2.25zm-6.75 13.5h6.75v-7.5h-6.75v7.5z"
                        />
                      </svg>
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      >
                        <path
                          strokeLinecap="round"
                          strokeLinejoin="round"
                          d="M9 12.75L11.25 15 15 9.75m-3-7.5A2.25 2.25 0 003.75 4.5v15A2.25 2.25 0 006 21.75h12A2.25 2.25 0 0021.75 19.5v-15A2.25 2.25 0 0018 1.5H6z"
                        />
                      </svg>
                      <div className="flex-1">
